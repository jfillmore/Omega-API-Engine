...
class OmegaConfig extends OmegaRESTful {
    public $config;
    private $config_path;
    ...
    public function __construct($config_path) {
        ...
        if (is_file($config_path)) {
            ...
            $this->config = json_decode($lines, true);
    ...
    /** Gets a specific API configuration item (e.g. 'omega.key'). If the item isn't found the 'else' parameter will be returned instead, if provided.
    ...
    /** Set the base API configuration.
        expects:
            nickname=string
            key=string
            class_dirs=array
